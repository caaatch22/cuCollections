...
template <typename Key,
          ...
          typename StorageRef,
          typename... Operators>
__host__ __device__ constexpr flat_hash_map_ref<
  Key,
  T,
  Scope,
  KeyEqual,
  ProbingScheme,
  StorageRef,
  Operators...>::flat_hash_map_ref(cuco::empty_key<Key> empty_key_sentinel,
...
__host__ __device__ constexpr flat_hash_map_ref<Key,
                                                T,
                                                Scope,
                                                KeyEqual,
                                                ProbingScheme,
                                                ...
                                                Operators...>::
  flat_hash_map_ref(
    flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, OtherOperators...>&&
      other) noexcept
...
__host__ __device__ constexpr flat_hash_map_ref<Key,
                                                ...
                                                StorageRef,
                                                Operators...>::key_equal
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::key_eq()
  const noexcept
{
...
__host__ __device__ constexpr flat_hash_map_ref<Key,
                                                ...
                                                StorageRef,
                                                Operators...>::hasher
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::hash_function()
  const noexcept
{
...
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::end()
  const noexcept
{
...
__host__ __device__ constexpr flat_hash_map_ref<Key,
                                                ...
                                                StorageRef,
                                                Operators...>::iterator
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::end() noexcept
{
  return this->impl_.end();
}
...
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::capacity()
  const noexcept
{
...
template <typename Key,
          ...
          typename... Operators>
__host__ __device__ constexpr auto
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::storage_ref()
  const noexcept
{
...
template <typename Key,
          ...
          typename... Operators>
__host__ __device__ constexpr auto
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::
...
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::extent()
  const noexcept
{
  return impl_.extent();
}
...
__host__ __device__ constexpr flat_hash_map_ref<Key,
                                                ...
                                                StorageRef,
                                                Operators...>::extent_type
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::bucket_extent()
  const noexcept
{
  return this->extent();
}
...
{
  return flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, NewOperators...>{
...
__host__ __device__ constexpr auto
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::rebind_key_eq(
  NewKeyEqual const& key_equal) const noexcept
{
  return flat_hash_map_ref<Key, T, Scope, NewKeyEqual, ProbingScheme, StorageRef, Operators...>{
    cuco::empty_key<Key>{this->empty_key_sentinel()},
    cuco::empty_value<T>{this->empty_value_sentinel()},
    key_equal,
    this->probing_scheme(),
...
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::make_copy(
  CG tile,
  ...
  cuda_thread_scope<NewScope> scope) const noexcept
{
  ...
  return flat_hash_map_ref<Key, T, NewScope, KeyEqual, ProbingScheme, StorageRef, Operators...>{
    cuco::empty_key<Key>{this->empty_key_sentinel()},
    cuco::empty_value<T>{this->empty_value_sentinel()},
...
flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>::initialize(
  CG tile) noexcept
{
...
class operator_impl<
  op::insert_tag,
  flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>> {
  using base_type = flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef>;
  using ref_type =
    flat_hash_map_ref<Key, T, Scope, KeyEqual, ProbingScheme, StorageRef, Operators...>;
