...
#include <cuco/detail/flat_hash_map/helpers.cuh>
#include <cuco/detail/flat_hash_map/kernels.cuh>
#include <cuco/detail/utility/cuda.hpp>
#include <cuco/detail/utils.hpp>
#include <cuco/flat_hash_map_ref.cuh>
...
template <class Key,
          ...
          class Allocator,
          class Storage>
constexpr flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::
  flat_hash_map(Extent capacity,
...
template <class Key,
          ...
          class Allocator,
          class Storage>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::clear(
  cuda::stream_ref stream)
{
  impl_->clear(stream);
}
...
template <class Key,
          ...
          class Allocator,
          class Storage>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::clear_async(
...
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::size_type
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::insert(
...
template <class Key,
          ...
          class Storage>
template <typename InputIt>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::
...
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::size_type
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::insert_if(
  ...
  insert_or_assign_async(InputIt first, InputIt last, cuda::stream_ref stream) noexcept
{
  ...
  detail::flat_hash_map_ns::insert_or_assign<cg_size, cuco::detail::default_block_size()>
  ...
  insert_or_apply_async(InputIt first, InputIt last, Op op, cuda::stream_ref stream) noexcept
{
  ...
  detail::flat_hash_map_ns::dispatch_insert_or_apply<has_init, cg_size, Allocator>(
...
template <class Key,
          ...
          class Storage>
template <typename InputIt>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::erase(
  InputIt first, InputIt last, cuda::stream_ref stream)
{
...
template <class Key,
          ...
          class Storage>
template <typename InputIt>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::erase_async(
  InputIt first, InputIt last, cuda::stream_ref stream)
{
...
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::contains(
...
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::contains_if(
  InputIt first,
  InputIt last,
  StencilIt stencil,
  Predicate pred,
...
template <class Key,
          ...
          class Storage>
template <typename InputIt, typename OutputIt>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::find(
  InputIt first, InputIt last, OutputIt output_begin, cuda::stream_ref stream) const
{
...
template <class Key,
          ...
          class Storage>
template <typename InputIt, typename OutputIt>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::find_async(
  InputIt first, InputIt last, OutputIt output_begin, cuda::stream_ref stream) const
{
...
template <class Key,
          ...
          class Storage>
template <typename InputIt, typename StencilIt, typename Predicate, typename OutputIt>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::find_if(
  InputIt first,
  InputIt last,
  StencilIt stencil,
  Predicate pred,
...
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::for_each(
...
template <typename InputIt>
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::size_type
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::count(
...
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::retrieve(
  InputIt first,
  InputIt last,
...
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::retrieve_all(
...
template <class Key,
          ...
          class Allocator,
          class Storage>
void flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::rehash(
  cuda::stream_ref stream)
{
...
{
  auto const extent = make_valid_extent<flat_hash_map>(capacity);
...
template <class Key,
          ...
          class Storage>
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::size_type
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::size(
  cuda::stream_ref stream) const
{
...
template <class Key,
          ...
          class Storage>
constexpr auto
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::capacity()
  const noexcept
{
...
template <class Key,
          ...
          class Storage>
__host__ auto
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::data() const
  -> value_type*
{
  return impl_->data();
}
...
constexpr flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::
  key_type
  flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::
...
constexpr flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::
  key_equal
  flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::key_eq()
    const noexcept
{
  return impl_->key_eq();
}
...
template <class Key,
          ...
          class Allocator,
          class Storage>
constexpr flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::hasher
flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::hash_function()
  const noexcept
{
...
auto flat_hash_map<Key, T, Extent, Scope, KeyEqual, ProbingScheme, Allocator, Storage>::ref(
