...
class flat_hash_map_ref
 ...
 public:
  ...
  /**
   * @brief Constructs flat_hash_map_ref.
   *
   ...
   */
  __host__ __device__ explicit constexpr flat_hash_map_ref(
 ...
 private:
  impl_type impl_;  ///< Flat hash map ref implementation
  ...
  template <typename Key_,
            ...
            typename... Operators_>
  friend class flat_hash_map_ref;
};

}  // namespace cuco

#include <cuco/detail/flat_hash_map/flat_hash_map_ref.inl>
